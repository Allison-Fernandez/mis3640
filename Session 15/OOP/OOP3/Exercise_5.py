class Exercise:
    ...
    def __init__(self, muscle, calorie):
        ...
        """
        self.muscle = muscle
        self.skill = []    # creates a new empty list for each exer
    ...
    def __str__(self):
        ...
        """
        return 'This is my first exercise{} that will burn {} calories'.format(self.skill, self.calorie)
